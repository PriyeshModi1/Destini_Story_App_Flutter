...
class StoryBrain {
  ...
  //TODO: Step 8 - Create a method called getStory() that returns the first storyTitle from storyData.
  String getStory() {
  ...
  //TODO: Step 11 - Create a method called getChoice1() that returns the text for the first choice1 from storyData.
  String getChoice1() {
    //TODO: Step 23 - Use the _storyNumber property inside getStory(), getChoice1() and getChoice2() so that it gets the updated story and choices rather than always just the first (0th) one.
    return storyData[_storyNumber].choice1;
  }

  //TODO: Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from storyData.
  String getChoice2() {
    //TODO: Step 23 - Use the _storyNumber property inside getStory(), getChoice1() and getChoice2() so that it gets the updated story and choices rather than always just the first (0th) one.
